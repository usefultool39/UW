...
export const SCENE_DEFINITIONS = {
  reading_hall: { id: 'reading_hall', mapId: 'novice_open', regionId: 'novice_village', role: 'explore', regionType: 'interact', roleLabel: '探索区', zoneColor: 0x7dd3fc, label: '村西书道', playMode: 'field', status: 'open' },
  church_library: { id: 'church_library', mapId: 'novice_open', regionId: 'novice_village', role: 'study', regionType: 'interact', roleLabel: '书库研读', zoneColor: 0x60a5fa, label: '村西书库', playMode: 'field', status: 'open' },
  home_hearth: { id: 'home_hearth', mapId: 'novice_open', regionId: 'novice_village', role: 'rest', regionType: 'rest', roleLabel: '休息区', zoneColor: 0xf59e0b, label: '家中炉火', playMode: 'field', status: 'open' },
  village_square: { id: 'village_square', mapId: 'novice_open', regionId: 'novice_village', role: 'social', regionType: 'interact', roleLabel: '村内交流', zoneColor: 0x34d399, label: '村道广场', playMode: 'field', status: 'open' },
  ...
  gigas_clearing: { id: 'gigas_clearing', mapId: 'novice_open', regionId: 'novice_village', role: 'work', regionType: 'work', roleLabel: '训练区', zoneColor: 0xfacc15, label: '古誓树清场', playMode: 'field', status: 'open' },
  north_gate: { id: 'north_gate', mapId: 'novice_open', regionId: 'novice_village', role: 'boundary', regionType: 'boundary', roleLabel: '边界调查', zoneColor: 0xf472b6, label: '北境边门', playMode: 'field', status: 'open' },
