# VIS-CHR-003_portrait_delivery_v004
...
- v003 (VIS-CHR-003_eugeo_sprite_sheet_v003.png): 768x384 RGBA 程序化 sprite sheet, 4 方向 × 12 帧 = 48 帧, 64x96 frame cell, bottom-center foot anchor. **结构合格, 美术质量低 (几何抽象)。**
- v004 (VIS-CHR-003_eugeo_portrait_v004.png): 2048x2048 RGB AI 立绘参考, 全身正面, 纯白背景, **视觉参考, 不进 runtime, 需美术重画 sprite 4 方向 × 12 帧时使用**。
...
|---|---|---|---|
| VIS-CHR-003-portrait-v004 | visual/characters/VIS-CHR-003_eugeo_portrait_v004.png | 4571a20aa059442ad6ab3642ff440a98fa9d728f8662e839ae40c627e81941e3 | 1110600 |

## 7. Manifest 片段

- 路径: `materials/inbox/visual/characters/VIS-CHR-003_v004_manifest_fragment.csv`
