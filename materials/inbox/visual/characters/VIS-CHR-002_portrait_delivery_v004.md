# VIS-CHR-002_portrait_delivery_v004
...
- v003 (VIS-CHR-002_alice_sprite_sheet_v003.png): 768x384 RGBA 程序化 sprite sheet, 4 方向 × 12 帧 = 48 帧, 64x96 frame cell, bottom-center foot anchor. **结构合格, 美术质量低 (几何抽象)。**
- v004 (VIS-CHR-002_alice_portrait_v004.png): 2048x2048 RGB AI 立绘参考, 全身正面, 纯白背景, **视觉参考, 不进 runtime, 需美术重画 sprite 4 方向 × 12 帧时使用**。
...
|---|---|---|---|
| VIS-CHR-002-portrait-v004 | visual/characters/VIS-CHR-002_alice_portrait_v004.png | 38bed653cefe847d9a486cd45f53ecf005acdc7475598a7154dcc0cf03b70cb9 | 1148711 |

## 7. Manifest 片段

- 路径: `materials/inbox/visual/characters/VIS-CHR-002_v004_manifest_fragment.csv`
