# 下一阶段：Pre-Capture 主线收束与真人验证

> 本阶段必须先遵守 [产品方向与长期开发基线](../product/PRODUCT_DIRECTION.md)。当前先整理正典主线和垂直切片，不继续扩写长期日期循环；视觉智能体只处理 `VIS-*` 素材请求。

- **状态**：Current / 长期目标已激活；暂停 Day 118+，将现有系统收束到爱丽丝被带走前的完整主线（2026-08-06）
...
在保留 Day 1–117 作为兼容内容和系统验证基线的前提下，下一步不再继续增加日期，而是形成四幕、8–12 个关键节点的 Pre-Capture 正式主线。具体执行与素材入口见 `materials/11_PRECAPTURE_EXECUTION_BRIEF.md`。

当前顺序：官方事实表与用户返还素材验收 → 宏观/微观世界观与人物动机 → 四幕事件卡 → 运行时接入 → 连续性测试与真人盲测。爱丽丝被带走之后的内容不在本阶段内。
...
# 2026-08-07 asset execution correction

- Treat `docs/delivery/MATERIALS_AUDIT_20260807.md` as the current asset queue and acceptance snapshot.
- Existing `VIS-KA-001`, `VIS-POR-001`, `VIS-UI-001`, `AUD-BGM-001`, and `AUD-AMB-001` are candidates/internal-test assets, not proof of a complete visual/audio pass.
- No files have been delivered yet for `VIS-MAP-001`, `VIS-POR-002`, `VIS-CHR-001` to `VIS-CHR-005`, `VIS-ANIM-001`, `VIS-TILE-001`, `VIS-ENV-001`, `VIS-UI-002`, `VIS-VFX-001`, `AUD-BGM-002`, `AUD-BGM-003`, `AUD-AMB-002`, `AUD-SFX-001`, or `AUD-SFX-002`.
- Generate and review the Pre-Capture blockers before marketing, voice, full combat animation, or chapter-scale expansion.
