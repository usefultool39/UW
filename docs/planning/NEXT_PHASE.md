...
1. 为 Day 54–61 增加第二月结果后的短尾声：同伴复盘、村务反馈和第三月出发准备，避免 Day 53 后立刻回到空白日常。
2. 让 Day 53 的四个第三月入口至少各产生一条 Day 54–61 NPC 主动反馈；先复用现有地图，不扩张大区域。
3. 补一个“第二月路线摘要”公开视图，让玩家从日志或月计划中看清自己走过的选择链和当前承诺。
4. 等首轮真人盲测回填后，只修复最高频 Day 1–3 卡点；继续保持 `pending-human-run`，不拿自动化代替玩家证据。
5. Underworld AI 继续遵守候选预览、白名单 intent、预算和 Session 权威边界；本阶段不接真实 Provider，不读取 `ai-shop`。

完成定义：Day 54–61 至少有一个 10–15 分钟可重复尾声循环，四个 Day 53 结果都能被 NPC 和日志读到，并通过后端、前端、build、E2E、内容校验和 Git 推送。
