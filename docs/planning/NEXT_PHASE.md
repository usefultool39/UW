...
- **状态**：Current / 唯一可执行计划（方向调整，2026-08-05）
- **阶段代号**：M3 Underworld Narrative Baseline & Event-Gated Days
- **目标版本**：`0.5.0-playable-day1`
...
- [ ] 玩家无法在未完成必需事件时绕过剧情闸跨日。
- [ ] 完成日结算后，日期自动推进并出现下一日目标。
- [ ] 自动 tick、NPC 日程、存档导入导出和 scripted 离线模式仍可用。
- [ ] 后端测试、前端单测、build 和 E2E 通过。
